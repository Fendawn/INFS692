...
```{r}
h2o.performance(ensemble, newdata = test_h2o)@metrics$RMSE
...
ensemble <- h2o.stackedEnsemble(
  x = X, y = Y, training_frame = train_h2o, model_id = "ensemble_gbm_grid",
  base_models = list(best_glm, best_rf, best_gbm), metalearner_algorithm = "gbm",
)
```
...
auto_ml <- h2o.automl(
  ...
  max_runtime_secs = 60 * 120, max_models = 10,
...
# Plot of top 20 important features during Training
...
# Plot ROC curves for AUC metrics
